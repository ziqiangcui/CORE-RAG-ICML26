...
model_path="../../../LLaMA-Factory/saves/qwen2.5_1.5B/full/deepseek_distill_sft/2wiki_lr5e5_epoch2_bs128_contriever"
data_path="../../data"
...
CUDA_VISIBLE_DEVICES=0,1,2,3,4,5,6,7 python3 -m verl.trainer.main_ppo \
    ...
    trainer.experiment_name='rollout5_lr1e5_alldata_rw4_res64' \
    ...
    custom_reward_function.name=compute_score_2wiki \
